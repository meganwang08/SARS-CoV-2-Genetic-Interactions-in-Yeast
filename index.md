...
# Abstract
To characterize the genetic interactions of SARS-CoV-2 proteins, we performed Selective Ploidy Ablation (SPA) in S. cerevisiae expressing individual viral proteins to identify synthetic dosage lethal (SDL) and suppressor-like interactions. Both interaction categories are necessary for elucidating the role of viral proteins in host cells. SDL interactions identify the genetic pathways that are stressed in the presence of viral proteins, and suppressor-like interactions suggest host cell proteins that are necessary for viral protein function. Nonstructural protein 14 (Nsp14) functions as both an exoribonuclease and an S-adenosylmethionine (SAM) dependent methyltransferase. In S. cerevisiae, the methyltransferase domain of Nsp14 confers a growth defect, and the severity in the reduction of growth was not compatible with our traditional SPA screening system. However, co-expression of Nsp14 with Nsp10 (viral replication complex stabilizer) leads to methyltransferase-dependent SDL interactions between pathways involved in the kinetochore-microtubule interface and mitochondrial functions. Additionally, Nsp14 suppressor-like interactions were discovered in pathways relating to SAM recycling.
